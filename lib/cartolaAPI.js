...
cartolaAPI.prototype.atletasPontuados = function(fn) {
  var self = this;
  self._baseRequest('/atletas/pontuados', fn);
}

cartolaAPI.prototype.time = function(time, fn) {
  var self = this;
  self._baseRequest('/time/' + time, fn);
}

cartolaAPI.prototype.times = function(time, fn) {
  var self = this;
  self._baseRequest('/times?q=' + encodeURIComponent(time), fn);
}
